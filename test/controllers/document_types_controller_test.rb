...
class DocumentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create document_type" do
    assert_difference('DocumentType.count') do
      post document_types_url, params: { document_type: { description: @document_type.description, file: @document_type.file, name: @document_type.name, responsible: @document_type.responsible } }
    end
  ...
  test "should update document_type" do
    patch document_type_url(@document_type), params: { document_type: { description: @document_type.description, file: @document_type.file, name: @document_type.name, responsible: @document_type.responsible } }
