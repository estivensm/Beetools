...
class ProcesosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proceso" do
    assert_difference('Proceso.count') do
      post procesos_url, params: { proceso: { admin_user: @proceso.admin_user, description: @proceso.description, name: @proceso.name, prefix: @proceso.prefix, proces_type: @proceso.proces_type, user_id: @proceso.user_id } }
    end
  ...
  test "should update proceso" do
    patch proceso_url(@proceso), params: { proceso: { admin_user: @proceso.admin_user, description: @proceso.description, name: @proceso.name, prefix: @proceso.prefix, proces_type: @proceso.proces_type, user_id: @proceso.user_id } }
